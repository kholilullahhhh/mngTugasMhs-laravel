                            ...
                            <div class="card form-section">
                                <div class="form-body">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label
                                            class="col-form-label text-md-right col-12 col-md-3 col-lg-3 required-field">Tugas</label>
                                    ...
                                    <div class="form-group row mb-4">
                                        <label
                                            class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Mahasiswa</label>
                                        <div class="col-sm-12 col-md-7">
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <textarea name="nilai" class="form-control" rows="3"
                                                placeholder="Tambahkan nilai ">{{ old('nilai', $data->nilai) }}</textarea>
                                            s
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-sm-12 col-md-7">
                                                <select name="validation_status" class="form-control" required>
                                                    ...
                                                    <option value="pending" {{ old('validation_status', $data->validation_status) == 'pending' ? 'selected' : '' }}>Pending
                                                    </option>
                                                    <option value="validated" {{ old('validation_status', $data->validation_status) == 'validated' ? 'selected' : '' }}>Valid
                                                    </option>
                                                    <option value="rejected" {{ old('validation_status', $data->validation_status) == 'rejected' ? 'selected' : '' }}>Ditolak
                                                    </option>
                                                </select>
                                    ...
                                    @else
                                        <input type="hidden" name="validation_status"
                                            value="{{ old('validation_status', $data->validation_status) }}">
                                    @endif
